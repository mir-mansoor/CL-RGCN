...
class RGCN(nn.Module):
    ...
    # def _gat_alpha_and_msgproj_for_aug_edges(self, conv, x, edge_index, edge_is_aug, edge_type):
    #     """
    #     Returns:
    ...
    #     # ===================== PRODUCTION HARD GATING: TOP5 INCOMING + TOP5 OUTGOING =====================
    #
    #     return alpha, Wx_src
    ...
    def _gat_alpha_and_msgproj_for_aug_edges(self, conv, x, edge_index, edge_is_aug, edge_type, debug_seed_nodes=None):
        ...
        # ======================= DEBUG: AUGMENTED EDGE ALPHA PER SEED =======================

        # pick the FIRST seed that actually has any augmented edge touching it
        # pick the seed that has the MOST augmented edges touching it
        ...
        # # ======================= HARD GATE: top-k IN + top-k OUT + SELF =======================
        # ---- STANDARD GAT: attention dropout AFTER softmax ----

        # ===================== HARD GATING: TOP-K IN + TOP-K OUT + SELF =====================
        # Apply only if debug_seed_nodes is provided (you can pass your batch seed nodes here).
        # ---- STANDARD GAT: attention dropout AFTER softmax ----


        # ===================== HARD GATING: TOP-K IN + TOP-K OUT + SELF (NO DEBUG) =====================
        #OR
